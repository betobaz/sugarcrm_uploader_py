...
import csv
host = "https://maquinter.sugarondemand.com/"
#host = "http://maquinter.merxbp.com/"
user_name = "rocampo"
password = "Pass2015"
clientId = "sugar"
clientSecret = ""
...
with open('result.csv', 'wb') as csvfile:
  ...
  for dirname, dirnames, filenames in os.walk(u"./descs"):
    for filename in filenames:
      ...
      if file_extension == ".pdf":
        ...
        if result['id'] :
          ...
          url = "{host}#bwc/index.php?module=Documents&action=DetailView&record={document_id}".format(document_id=document_id, host=host) 
